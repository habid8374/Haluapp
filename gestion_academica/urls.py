...
urlpatterns = [
    ...
    path('simulaciones-steam/<int:pk>/abrir/', views.abrir_simulacion_steam, name='abrir_simulacion_steam'),
    ...
    path('periodos/<int:periodo_pk>/cerrar/', views.cerrar_periodo_y_notificar, name='cerrar_periodo'),
    path('periodos/<int:periodo_pk>/reabrir/', views.reabrir_periodo_notas, name='reabrir_periodo'),
    path('periodos/<int:periodo_pk>/publicar-boletines/', views.publicar_boletines_periodo, name='publicar_boletines_periodo'),
    path('periodos/<int:periodo_pk>/despublicar-boletines/', views.despublicar_boletines_periodo, name='despublicar_boletines_periodo'),
    ...
    path('deberes/<int:deber_pk>/simplificar/', views.simplificar_descripcion_deber, name='simplificar_descripcion_deber'),
    path('boletin/observacion/<int:observacion_pk>/simplificar/', views.simplificar_observacion_boletin, name='simplificar_observacion_boletin'),
    path('ayuda/docente/', views.centro_ayuda_docente, name='centro_ayuda_docente'),
    ...
    path('accesibilidad/estudiante/<int:estudiante_pk>/', views.editar_perfil_accesibilidad, name='editar_perfil_accesibilidad'),
    path('ia/consumo/', views.consumo_ia, name='consumo_ia'),
    ...
    path('politica-datos/constancia/', views.constancia_aceptacion_politica, name='constancia_aceptacion_politica'),
    path('politica-datos/constancia/<int:usuario_id>/', views.constancia_aceptacion_politica, name='constancia_aceptacion_politica'),
    ...
    path('estudiante/mis-justificaciones/', views.MisJustificacionesInasistenciaListView.as_view(), name='mis_justificaciones_inasistencia'),
    path('estudiante/justificar-inasistencia/', views.CrearJustificacionInasistenciaView.as_view(), name='crear_justificacion_inasistencia'),
    path('estudiante/justificar-inasistencia/<int:pk>/editar/', views.EditarJustificacionInasistenciaView.as_view(), name='editar_justificacion_inasistencia'),
    path('estudiante/justificar-inasistencia/<int:pk>/eliminar/', views.eliminar_justificacion_inasistencia, name='eliminar_justificacion_inasistencia'),
    path('gestion/justificaciones-inasistencia/', views.revisar_justificaciones_inasistencia, name='revisar_justificaciones_inasistencia'),
    path('gestion/justificaciones-inasistencia/<int:pk>/aprobar/', views.aprobar_justificacion_inasistencia, name='aprobar_justificacion_inasistencia'),
    path('gestion/justificaciones-inasistencia/<int:pk>/rechazar/', views.rechazar_justificacion_inasistencia, name='rechazar_justificacion_inasistencia'),
    ...
    path('familiares/<int:pk>/editar/', views.editar_familiar, name='editar_familiar'),
    path('familiares/<int:pk>/eliminar/', views.eliminar_familiar, name='eliminar_familiar'),
    ...
    # --- Citas de Orientación (Psicoorientador ↔ Familia) ---
    path('orientacion/disponibilidad/', views.gestionar_disponibilidad_orientador_view, name='gestionar_disponibilidad_orientador'),
