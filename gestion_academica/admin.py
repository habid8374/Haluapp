...
class UsuarioAdmin(InstitucionScopedAdminMixin, BaseUserAdmin):
    ...
    # add_fieldsets por defecto de Django solo trae username + contraseñas;
    # lo redeclaramos para sumar los campos mínimos de este proyecto (rol e
    # institución) al crear un usuario desde el admin.
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
...
class GrupoAdmin(InstitucionScopedAdminMixin, admin.ModelAdmin):
    list_display = ('nombre', 'grado', 'jornada', 'sede', 'institucion', 'activo')
