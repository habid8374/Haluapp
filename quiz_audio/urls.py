...
urlpatterns = [
    ...
    path('<int:pk>/pregunta/agregar/', views.agregar_pregunta, name='agregar_pregunta'),
    path('<int:pk>/pregunta/<int:pregunta_pk>/editar/', views.editar_pregunta, name='editar_pregunta'),
