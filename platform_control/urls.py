...
urlpatterns = [
    ...
    path("modulos/",                            views.modulos_index,              name="modulos"),
    path("modulos/<int:pk>/",                   views.modulos_institucion,        name="modulos_institucion"),
    ...
    path("mantenimiento/<int:pk>/descargar/<str:formato>/", views.mantenimiento_descargar, name="mantenimiento_descargar"),
