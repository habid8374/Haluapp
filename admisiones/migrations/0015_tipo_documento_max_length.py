...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('admisiones', '0014_aspirante_simat_codificados'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='aspirante',
            name='acudiente_tipo_documento',
            field=models.CharField(blank=True, choices=_TD, max_length=5, null=True, verbose_name='Acudiente · Tipo de documento'),
        ),
    ]
