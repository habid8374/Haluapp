...
def _construir_plantilla_aspirantes(institucion):
    ...
    columnas = [
        ...
        ('campesino', 'SI o NO'),
        ('sisben_simat', 'Selecciona (lista)'),
        ('proviene_sector_privado', 'SI o NO'),
        ('proviene_otro_municipio', 'SI o NO'),
        ('madre_cabeza_familia', 'S o N'),
        ('hijo_madre_cabeza_familia', 'S o N'),
        ('beneficiario_veterano', 'S o N'),
        ('beneficiario_heroe', 'S o N'),
        ('cod_depto_expulsor', 'Selecciona (lista)'),
        ('cod_mpio_expulsor', 'Selecciona (lista)'),
        # ── 8) Matrícula SIMAT (reporte oficial) ──
        ('caracter', 'Selecciona (lista)'),
        ('especialidad', 'Selecciona (lista)'),
        ('metodologia', 'Selecciona (lista)'),
        ('situacion_va', 'Selecciona (lista)'),
        ('condicion_va', 'Selecciona (lista)'),
        ('fuente_recurso', 'Selecciona (lista)'),
        ('tipo_internado', 'Selecciona (lista)'),
        ('valoracion_p1', 'Selecciona (lista)'),
        ('valoracion_p2', 'Selecciona (lista)'),
        ('subsidiado', 'SI o NO'),
        ('es_nuevo', 'SI o NO'),
        ('numero_convenio', 'N.º de convenio (si aplica)'),
        ('institucion_bienestar', 'Institución ICBF (si aplica)'),
        # ── 9) Acudiente / Familiar (se crea su cuenta y se vincula) ──
    ...
    dvs = {
        ...
        'proviene_sector_privado': '"SI,NO"', 'proviene_otro_municipio': '"SI,NO"',
        'madre_cabeza_familia': '"S,N"', 'hijo_madre_cabeza_familia': '"S,N"',
        'beneficiario_veterano': '"S,N"', 'beneficiario_heroe': '"S,N"',
        'cod_depto_expulsor': ref_depto, 'cod_mpio_expulsor': ref_mpio,
        'caracter': '"1,2,0"',
        'especialidad': '"05,06,08,09,10,11,07,00"',
        'metodologia': '"1,2,3,4,5,8,9,10,11,12,39,43,51"',
        'situacion_va': '"0,1,2,4,6,7,8"',
        'condicion_va': '"3,5,9"',
        'fuente_recurso': '"1,2,3,4,5"',
        'tipo_internado': '"1,2,3"',
        'valoracion_p1': '"1,2,3,4"', 'valoracion_p2': '"1,2,3,4"',
        'subsidiado': '"SI,NO"', 'es_nuevo': '"SI,NO"',
    }
